...
<section class="main-content container-lg mb-5">
  ...
  <div class="p-4 border-top shadow-sm rounded-3">
    <div class="my-3 w-100">
      <h4 class="d-flex justify-content-center">THÊM ĐỊA ĐIỂM</h4>
    </div>
    @if (session('error'))
    ...
    <form action="{{ route('points.store') }}" method="POST" class='row' enctype="multipart/form-data">
      ...
      <div class="mb-3 col-12 col-md-6">
        ...
        <input name="block" type="text" class="form-control" value="{{old('block')}}">
      ...
      <div class="mb-3 col-12 col-md-6">
        ...
        <input name="floor" type="text" class="form-control" value="{{old('floor')}}">
      ...
      <div class="mb-3 col-12 col-md-6">
        ...
        <input name="room" type="text" class="form-control" value="{{old('room')}}">
